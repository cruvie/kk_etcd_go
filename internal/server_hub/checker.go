...
func startNewCheck(registration *kk_etcd_models.PBServerRegistration) {
...
func checkGrpc(checkConfig *kk_etcd_models.PBServerRegistration_PBCheckConfig) (err error) {
...
func checkHttp(checkConfig *kk_etcd_models.PBServerRegistration_PBCheckConfig) (err error) {
