...
func TestGenProtoSh(t *testing.T) {
	in := kk_protobuf.GenProtoShInput{
		HandlerPrePath:    "internal/mgr_hub/mgr_kv/",
		HandlerFolderList: []string{"/Users/cruvie/cruvie-space/code-hub/my-project/kk_etcd/kk_etcd_go/internal/mgr_hub/mgr_kv"},
		ProjectPath:       "../../../",
