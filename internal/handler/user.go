...
func Login(c *gin.Context) {
	...
	case 1:
		...
		kk_http.ResponseProtoBuf(c, kk_response.Success(stage, &kk_response.KKResponse{
...
func GetUser(c *gin.Context) {
	...
	switch res {
	case 1:
		kk_http.ResponseProtoBuf(c, kk_response.Success(stage, nil, user))
		return
	}
	kk_http.ResponseProtoBuf(c, kk_response.Fail(stage, nil, nil))
}
...
func UserList(c *gin.Context) {
	...
	switch res {
	case 1:
		kk_http.ResponseProtoBuf(c, kk_response.Success(stage, nil, users))
		return
	}
	kk_http.ResponseProtoBuf(c, kk_response.Fail(stage, nil, nil))
}
