...
func TestGenImpl(t *testing.T) {
	grpc_api_gen.GenerateImpl(grpc_api_gen.GenerateImplInput{
		...
		ApiDefPkgPath:   "github.com/cruvie/kk_etcd_go/internal/service_hub/ai/api_def",
		HandlersPkgPath: "github.com/cruvie/kk_etcd_go/internal/service_hub/ai/api_handlers",
	})
}
