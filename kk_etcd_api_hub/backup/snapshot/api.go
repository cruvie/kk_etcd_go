...
type api struct {
	...
	In    *api_def.Snapshot_Input
}

func NewApi(stage *kk_stage.Stage) *api {
	return &api{
		stage: stage,
		In:    new(api_def.Snapshot_Input),
	}
}
...
//		@Param			api_def.Snapshot_Input	body		api_def.Snapshot_Input	true	"Snapshot_Input"
//		@Success		200						{object}	api_def.Snapshot_Output
