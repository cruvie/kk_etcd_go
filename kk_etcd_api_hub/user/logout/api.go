...
type api struct {
	...
	In    *api_def.Logout_Input
}

func NewApi(stage *kk_stage.Stage) *api {
	return &api{
		stage: stage,
		In:    new(api_def.Logout_Input),
	}
}
...
//	@Param		api_def.Logout_Input	body		api_def.Logout_Input	true	"Logout_Input"
//	@Success	200						{object}	api_def.Logout_Output
