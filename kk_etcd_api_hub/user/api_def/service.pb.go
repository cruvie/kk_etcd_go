...
// 	protoc        (unknown)
// source: kk_etcd_api_hub/user/api_def/service.proto
...
var File_kk_etcd_api_hub_user_api_def_service_proto protoreflect.FileDescriptor

const file_kk_etcd_api_hub_user_api_def_service_proto_rawDesc = "" +
	"\n" +
	"*kk_etcd_api_hub/user/api_def/service.proto\x12\aapi_def\x1a*kk_etcd_api_hub/user/api_def/GetUser.proto\x1a(kk_etcd_api_hub/user/api_def/Login.proto\x1a)kk_etcd_api_hub/user/api_def/Logout.proto\x1a)kk_etcd_api_hub/user/api_def/MyInfo.proto\x1a*kk_etcd_api_hub/user/api_def/UserAdd.proto\x1a-kk_etcd_api_hub/user/api_def/UserDelete.proto\x1a0kk_etcd_api_hub/user/api_def/UserGrantRole.proto\x1a+kk_etcd_api_hub/user/api_def/UserList.proto2\xf8\x03\n" +
	"\x04User\x12:\n" +
...
var file_kk_etcd_api_hub_user_api_def_service_proto_goTypes = []any{
...
var file_kk_etcd_api_hub_user_api_def_service_proto_depIdxs = []int32{
...
func init() { file_kk_etcd_api_hub_user_api_def_service_proto_init() }
func file_kk_etcd_api_hub_user_api_def_service_proto_init() {
	if File_kk_etcd_api_hub_user_api_def_service_proto != nil {
		return
	}
	file_kk_etcd_api_hub_user_api_def_GetUser_proto_init()
	file_kk_etcd_api_hub_user_api_def_Login_proto_init()
	file_kk_etcd_api_hub_user_api_def_Logout_proto_init()
	file_kk_etcd_api_hub_user_api_def_MyInfo_proto_init()
	file_kk_etcd_api_hub_user_api_def_UserAdd_proto_init()
	file_kk_etcd_api_hub_user_api_def_UserDelete_proto_init()
	file_kk_etcd_api_hub_user_api_def_UserGrantRole_proto_init()
	file_kk_etcd_api_hub_user_api_def_UserList_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_kk_etcd_api_hub_user_api_def_service_proto_rawDesc), len(file_kk_etcd_api_hub_user_api_def_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_kk_etcd_api_hub_user_api_def_service_proto_goTypes,
		DependencyIndexes: file_kk_etcd_api_hub_user_api_def_service_proto_depIdxs,
	}.Build()
	File_kk_etcd_api_hub_user_api_def_service_proto = out.File
	file_kk_etcd_api_hub_user_api_def_service_proto_goTypes = nil
	file_kk_etcd_api_hub_user_api_def_service_proto_depIdxs = nil
}
