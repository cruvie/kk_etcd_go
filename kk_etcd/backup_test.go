...
//	}
//	response, err := mgrBackup.SnapshotInfo(&api_def2.SnapshotInfo_Input{File: bytes})
//	if err != nil {
//		log.Println(err)
//		return
//	}
...
//
//	err, response := mgrBackup.AllKVsRestore(&api_def2.AllKVsRestore_Input{File: []byte(jsonStr)})
//	if err != nil {
//		log.Println(err)
//		return
//	}
