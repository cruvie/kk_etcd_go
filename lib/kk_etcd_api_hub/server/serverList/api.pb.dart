...
class ServerList_Input extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServerList.Input', package: const $pb.PackageName(_omitMessageNames ? '' : 'serverList'), createEmptyInstance: create)
...
class ServerList_Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServerList.Output', package: const $pb.PackageName(_omitMessageNames ? '' : 'serverList'), createEmptyInstance: create)
    ..aOM<$1.PBListServer>(1, _omitFieldNames ? '' : 'ServerList', protoName: 'ServerList', subBuilder: $1.PBListServer.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set serverList($1.PBListServer v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class ServerList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServerList', package: const $pb.PackageName(_omitMessageNames ? '' : 'serverList'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
