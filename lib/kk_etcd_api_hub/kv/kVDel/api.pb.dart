...
//  source: kk_etcd_api_hub/kv/kVDel/api.proto
//
// @dart = 3.3
...
class KVDel_Input extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KVDel.Input', package: const $pb.PackageName(_omitMessageNames ? '' : 'kVDel'), createEmptyInstance: create)
...
class KVDel_Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KVDel.Output', package: const $pb.PackageName(_omitMessageNames ? '' : 'kVDel'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class KVDel extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KVDel', package: const $pb.PackageName(_omitMessageNames ? '' : 'kVDel'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
