...
class KVGet_Input extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KVGet.Input', package: const $pb.PackageName(_omitMessageNames ? '' : 'kVGet'), createEmptyInstance: create)
...
class KVGet_Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KVGet.Output', package: const $pb.PackageName(_omitMessageNames ? '' : 'kVGet'), createEmptyInstance: create)
...
class KVGet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KVGet', package: const $pb.PackageName(_omitMessageNames ? '' : 'kVGet'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
