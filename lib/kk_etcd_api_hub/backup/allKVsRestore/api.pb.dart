...
class AllKVsRestore_Input extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllKVsRestore.Input', package: const $pb.PackageName(_omitMessageNames ? '' : 'allKVsRestore'), createEmptyInstance: create)
...
class AllKVsRestore_Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllKVsRestore.Output', package: const $pb.PackageName(_omitMessageNames ? '' : 'allKVsRestore'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class AllKVsRestore extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllKVsRestore', package: const $pb.PackageName(_omitMessageNames ? '' : 'allKVsRestore'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
