...
class SnapshotRestore_Input extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SnapshotRestore.Input', package: const $pb.PackageName(_omitMessageNames ? '' : 'snapshotRestore'), createEmptyInstance: create)
...
class SnapshotRestore_Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SnapshotRestore.Output', package: const $pb.PackageName(_omitMessageNames ? '' : 'snapshotRestore'), createEmptyInstance: create)
...
class SnapshotRestore extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SnapshotRestore', package: const $pb.PackageName(_omitMessageNames ? '' : 'snapshotRestore'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
