...
//  source: kk_etcd_api_hub/user/userDelete/api.proto
//
// @dart = 3.3
...
class UserDelete_Input extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserDelete.Input', package: const $pb.PackageName(_omitMessageNames ? '' : 'userDelete'), createEmptyInstance: create)
...
class UserDelete_Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserDelete.Output', package: const $pb.PackageName(_omitMessageNames ? '' : 'userDelete'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class UserDelete extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserDelete', package: const $pb.PackageName(_omitMessageNames ? '' : 'userDelete'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
