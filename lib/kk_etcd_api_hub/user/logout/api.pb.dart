...
class Logout_Input extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Logout.Input', package: const $pb.PackageName(_omitMessageNames ? '' : 'logout'), createEmptyInstance: create)
...
class Logout_Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Logout.Output', package: const $pb.PackageName(_omitMessageNames ? '' : 'logout'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class Logout extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Logout', package: const $pb.PackageName(_omitMessageNames ? '' : 'logout'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
