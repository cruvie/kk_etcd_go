...
class UserGrantRole_Input extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserGrantRole.Input', package: const $pb.PackageName(_omitMessageNames ? '' : 'userGrantRole'), createEmptyInstance: create)
...
class UserGrantRole_Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserGrantRole.Output', package: const $pb.PackageName(_omitMessageNames ? '' : 'userGrantRole'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class UserGrantRole extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserGrantRole', package: const $pb.PackageName(_omitMessageNames ? '' : 'userGrantRole'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
