...
//  source: kk_etcd_api_hub/user/login/api.proto
//
// @dart = 3.3
...
class Login_Input extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Login.Input', package: const $pb.PackageName(_omitMessageNames ? '' : 'login'), createEmptyInstance: create)
...
class Login_Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Login.Output', package: const $pb.PackageName(_omitMessageNames ? '' : 'login'), createEmptyInstance: create)
...
class Login extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Login', package: const $pb.PackageName(_omitMessageNames ? '' : 'login'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
