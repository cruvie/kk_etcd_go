...
class RoleGet_Input extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RoleGet.Input', package: const $pb.PackageName(_omitMessageNames ? '' : 'roleGet'), createEmptyInstance: create)
...
class RoleGet_Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RoleGet.Output', package: const $pb.PackageName(_omitMessageNames ? '' : 'roleGet'), createEmptyInstance: create)
...
class RoleGet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RoleGet', package: const $pb.PackageName(_omitMessageNames ? '' : 'roleGet'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
