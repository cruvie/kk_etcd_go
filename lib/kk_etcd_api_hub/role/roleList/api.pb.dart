...
//  source: kk_etcd_api_hub/role/roleList/api.proto
//
// @dart = 3.3
...
class RoleList_Input extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RoleList.Input', package: const $pb.PackageName(_omitMessageNames ? '' : 'roleList'), createEmptyInstance: create)
...
class RoleList_Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RoleList.Output', package: const $pb.PackageName(_omitMessageNames ? '' : 'roleList'), createEmptyInstance: create)
...
class RoleList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RoleList', package: const $pb.PackageName(_omitMessageNames ? '' : 'roleList'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
