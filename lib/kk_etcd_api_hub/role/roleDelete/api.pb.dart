...
class RoleDelete_Input extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RoleDelete.Input', package: const $pb.PackageName(_omitMessageNames ? '' : 'roleDelete'), createEmptyInstance: create)
...
class RoleDelete_Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RoleDelete.Output', package: const $pb.PackageName(_omitMessageNames ? '' : 'roleDelete'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class RoleDelete extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RoleDelete', package: const $pb.PackageName(_omitMessageNames ? '' : 'roleDelete'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
