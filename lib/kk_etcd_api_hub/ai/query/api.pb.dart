...
class Query_Input extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Query.Input', package: const $pb.PackageName(_omitMessageNames ? '' : 'query'), createEmptyInstance: create)
...
class Query_Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Query.Output', package: const $pb.PackageName(_omitMessageNames ? '' : 'query'), createEmptyInstance: create)
...
class Query extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Query', package: const $pb.PackageName(_omitMessageNames ? '' : 'query'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
