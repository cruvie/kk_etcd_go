...
//
// Generated from internal/service_hub/role/api_def/RoleRevokePermission.proto.
...
class RoleRevokePermission_Input extends $pb.GeneratedMessage {
  ...
  RoleRevokePermission_Input._();

  factory RoleRevokePermission_Input.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RoleRevokePermission_Input.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$pb.TagNumber(3)
  set rangeEnd($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
...
class RoleRevokePermission_Output extends $pb.GeneratedMessage {
  ...
  factory RoleRevokePermission_Output.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RoleRevokePermission_Output.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
...
class RoleRevokePermission extends $pb.GeneratedMessage {
  ...
  RoleRevokePermission._();

  factory RoleRevokePermission.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RoleRevokePermission.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
