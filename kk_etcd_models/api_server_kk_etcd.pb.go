...
type DeregisterServerParam struct {
	...
	Target string `protobuf:"bytes,1,opt,name=Target,proto3" json:"Target,omitempty"` //ServerType/ServerName
	Key    string `protobuf:"bytes,2,opt,name=Key,proto3" json:"Key,omitempty"`       //ServerType/ServerName/Addr
}
...
func (x *DeregisterServerParam) GetTarget() string {
	if x != nil {
		return x.Target
	}
	return ""
...
func (x *DeregisterServerParam) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
var file_api_server_kk_etcd_proto_rawDesc = []byte{
	...
	0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x41, 0x0a, 0x15, 0x44, 0x65,
	0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x50, 0x61,
	0x72, 0x61, 0x6d, 0x12, 0x16, 0x0a, 0x06, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x4b,
	0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x4b, 0x65, 0x79, 0x22, 0x1a, 0x0a,
	0x18, 0x44, 0x65, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x13, 0x5a, 0x11, 0x2e, 0x2f, 0x3b,
